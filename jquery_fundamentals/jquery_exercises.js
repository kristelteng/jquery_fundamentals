...
// $(document).ready(function() {
//   $('.target').eq(1).css("background-color", "yellow");
// });
...
// $(document).ready(function () {
//  $('select option').filter(":odd").css("background-color", "yellow");
// });
